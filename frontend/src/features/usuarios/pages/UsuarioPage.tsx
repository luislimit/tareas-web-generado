...
const columns:GridColDef<Usuario>[]=[{field:'codigo',headerName:'Código',width:150},{field:'nombre',headerName:'Nombre',flex:1,minWidth:190},{field:'email',headerName:'Email',width:250},{field:'activo',headerName:'Estado',width:110,valueFormatter:v=>boolLabel(v,'Activo','Inactivo')}]
